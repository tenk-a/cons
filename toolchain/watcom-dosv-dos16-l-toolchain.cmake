#set(TOOLCHAIN_NAME "watcom-dosv-dos16-l" CACHE STRING "Toolchain name")
...
set(CMAKE_C_FLAGS   "-ml -k5000 -D__DOS__ -D__DOSV__ ${CMAKE_C_FLAGS}")
set(CMAKE_CXX_FLAGS "-ml -k5000 -D__DOS__ -D__DOSV__ ${CMAKE_CXX_FLAGS}")
