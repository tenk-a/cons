/**
 *  @file cons_dosv.h
 *  @brief A console screen library for DOS/V (Japan DOS/V).
 *  @author Masashi Kitamura ( https://github.com/tenk-a/ )
 *  @date   2025-09
 *  @license Boost Software License - Version 1.0
 */
#ifndef CONS_DOSV_H__
#define CONS_DOSV_H__
...
#define CONS_KEY_RIGHT          0xE04D
#define CONS_KEY_RETURN         0x0D
...
void cons_setcolor(cons_col_t co);
    ...
    extern cons_col_t   _cons_PRIVATE_col;
    extern unsigned     _cons_PRIVATE_active_cp;
...
#define cons_resetcolor(c)  (_cons_PRIVATE_col = CONS_COLOR_DEFAULT)
